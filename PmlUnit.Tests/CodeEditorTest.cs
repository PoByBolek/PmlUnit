...
namespace PmlUnit.Tests
{
    ...
    public class CodeEditorTest
    {
        ...
        [TestCase(typeof(PmlStudioCodeEditor), "", @"C:\path\to\file.pmlobj", 12345, "C:\\path\\to\\file.pmlobj /Command \"Edit.Goto 12345\"")]
        [TestCase(typeof(PmlStudioCodeEditor), "", @"C:\path\to\file.pmlobj", 0, @"C:\path\to\file.pmlobj")]
        [TestCase(typeof(PmlStudioCodeEditor), "", @"C:\path to\file.pmlobj", 1234, "\"C:\\path to\\file.pmlobj\" /Command \"Edit.Goto 1234\"")]
        [TestCase(typeof(PmlStudioCodeEditor), "", @"C:\path to\file.pmlobj", 0, "\"C:\\path to\\file.pmlobj\"")]
